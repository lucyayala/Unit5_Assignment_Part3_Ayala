...
This program converts a double number, entered by the user, into a string. 
*/
#include <iostream>
...
int main()
{
     while (myNumberAsString != "*") 
     {
       ...
       if (checkForInteger(myNumberAsString))
       {
         ...
         // This calls the function "EnglishNumber" and passes "number" as the parameter. "Number" is declared at line 116. It will help convert every double to a string as it loops.
         cout << "Converted, your number is: " << EnglishNumber(number);
